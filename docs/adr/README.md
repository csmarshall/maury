...
flowchart TD
    ...
    A0015 --> A0018a[0018 Bootstrap UX]
    ...
    A0022 --> A0026[0026 Profile-aware mining]
    ...
    A0024 --> A0025[0025 Profile switching]
    ...
    A0018b --> A0028[0028 Offline behavior]
...
The vocabulary and structural model. **Start here.**

| Read | About |
|---|---|
| [`0001`](0001-n-profiles.md) | N profiles (not hardcoded home/work); single-parent inheritance |
...
| [`0015`](0015-surrogate-keys-for-hosts-and-profiles.md) | `host_<hex>` and `profile_<hex>` IDs (rename-safe identity) |
...
| [`0027`](0027-cross-context-promotion-via-shared-root.md) | Inheritance graph constraint on promotion (no lateral cross-profile) |
...
The interaction surface with the agent it manages config for.
